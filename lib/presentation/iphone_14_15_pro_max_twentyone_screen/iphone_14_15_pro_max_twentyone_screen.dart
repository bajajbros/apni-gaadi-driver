...
class Iphone1415ProMaxTwentyoneScreen extends StatelessWidget {
  Iphone1415ProMaxTwentyoneScreen({Key? key})
      : super(
          key: key,
        );
            ...
            child: Column(
              children: [
                CustomElevatedButton(
                  onPressed: () {
                    Navigator.pushNamed(
                        context, AppRoutes.iphone1415ProMaxTwentythreeScreen);
                  },
                  height: 40.v,
                  text: "Ride log",
  ...
  /// Section Widget
  Widget _buildRideLogSection(BuildContext context) {
    return Container(
      padding: EdgeInsets.symmetric(
        horizontal: 15.h,
        vertical: 11.v,
